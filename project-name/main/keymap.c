...
uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   {
	...
	{KC_TAB,  KC_Q,    		KC_S,    	KC_D,    KC_F,    	KC_G,    KC_INT1, 	KC_J,    	KC_K,    KC_L,    	KC_P, 		KC_LBRC,     /**/KC_EQUAL},
	{KC_RALT, KC_A,    		KC_X,    	KC_C,    KC_V,    	KC_B,    KC_N,    	KC_M,    	KC_COMM, KC_DOT,  	KC_SCLN, 	KC_QUOT,     /**/KC_DELETE},
	{KC_LCTRL,KC_Z, 		KC_LALT, 	KC_LWIN, KC_LSHIFT, KC_SPC,  KC_BSPACE,	KC_ENTER,   KC_NUHS, KC_ENTER,	KC_SLSH,  	KC_GRV,      /**/KC_NO }
	},
   {
