...
#define CONFIG_GC9A01_SPI_HOST USE_SPI3_HOST
...
#define CONFIG_GC9A01_PIN_NUM_RST PIN_NUM_LCD_RST
#define CONFIG_GC9A01_PIN_NUM_DC PIN_NUM_LCD_DC
#define CONFIG_GC9A01_PIN_NUM_CS PIN_NUM_LCD_CS

#define CONFIG_GC9A01_PIN_NUM_MOSI PIN_NUM_LCD_PCLK
#define CONFIG_GC9A01_PIN_NUM_SCK PIN_NUM_LCD_DATA0

#define CONFIG_GC9A01_RESET_USED 1
#define CONFIG_GC9A01_CONTROL_BACK_LIGHT_USED 0
